...
/**
 * Criteria class for the {@link net.openobject.domain.Project} entity. This class is used
 * in {@link net.openobject.web.rest.ProjectResource} to receive all the possible filtering options from
