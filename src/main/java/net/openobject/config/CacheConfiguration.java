...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer(javax.cache.configuration.Configuration<Object, Object> jcacheConfiguration) {
        return cm -> {
            createCache(cm, net.openobject.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            createCache(cm, net.openobject.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
            createCache(cm, net.openobject.domain.User.class.getName(), jcacheConfiguration);
            createCache(cm, net.openobject.domain.Authority.class.getName(), jcacheConfiguration);
            ...
            createCache(cm, net.openobject.domain.Etest.class.getName(), jcacheConfiguration);
