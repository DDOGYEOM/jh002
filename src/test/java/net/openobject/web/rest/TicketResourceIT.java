...
class TicketResourceIT {
    ...
    void createTicket() throws Exception {
        ...
        restTicketMockMvc
            .perform(
                post("/api/tickets").with(csrf()).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(ticket))
            )
    ...
    void updateNonExistingTicket() throws Exception {
        ...
        restTicketMockMvc
            .perform(
                put("/api/tickets").with(csrf()).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(ticket))
            )
            .andExpect(status().isBadRequest());
    ...
    void deleteTicket() throws Exception {
        ...
        // Delete the ticket
        restTicketMockMvc
            .perform(delete("/api/tickets/{id}", ticket.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
